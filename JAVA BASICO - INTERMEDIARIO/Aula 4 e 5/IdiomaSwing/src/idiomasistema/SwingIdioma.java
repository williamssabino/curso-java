 ...
 * @author Usuário
 */
public class SwingIdioma extends javax.swing.JFrame {

    /**
     * Creates new form SwingIdioma
     */
    public SwingIdioma() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/idioma/download (1).jpg"))); // NOI18N
        ...
        lblSistema.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        lblSistema.setForeground(new java.awt.Color(102, 102, 102));
        lblSistema.setText("Clique No Botão");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SwingIdioma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SwingIdioma().setVisible(true);
            }
        });
    }
